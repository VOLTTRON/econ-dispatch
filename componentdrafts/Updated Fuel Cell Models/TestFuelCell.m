...
% Gen.AmbTemperature = 5/9*(AmbientTemperature-32);
...
%     Coef.NominalOCV = NominalV(i);
    ...
    Coef = FuelCell_Calibrate('PAFC','CH4',Gen.Power,Gen.Fuel/50144,Gen.Time,Gen.AmbTemperature,[],[],[],[],[],[],[],[],[]); % 50144 kJ/kg converts fuel kW to kg/s
