...
Tcho = xlsread('CH-Screw-Historical-Data','a2:a99999');% chilled water supply temperature in F
Tcdi = xlsread('CH-Screw-Historical-Data','b2:b99999');% condenser water temperature (outlet from heat rejection and inlet to chiller) in F
Qch = xlsread('CH-Screw-Historical-Data','c2:c99999');% chiller cooling output in Tons of cooling
P = xlsread('CH-Screw-Historical-Data','d2:d99999');% chiller power input in kW
[i,j]=size(Tcho);
U=ones(i,1);
% ***********************************************
...
%*************** Exporting Results ***************
xlswrite('CH-Screw-Model-Coefficients',AA,'a1:a4');
%*************************************************
