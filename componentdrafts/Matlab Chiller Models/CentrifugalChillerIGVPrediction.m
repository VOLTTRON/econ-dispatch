...
a0 = xlsread('CH-Cent-IGV-Model-Coefficients','a1:a1');
a1 = xlsread('CH-Cent-IGV-Model-Coefficients','a2:a2');
a2 = xlsread('CH-Cent-IGV-Model-Coefficients','a3:a3');
a3 = xlsread('CH-Cent-IGV-Model-Coefficients','a4:a4');
% ***********************************************
