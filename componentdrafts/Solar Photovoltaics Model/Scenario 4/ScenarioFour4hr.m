...
If = xlsread('Dynamic-Inputs-4','c2:c25');% Forecasted I (f denotes forecasted)
Taf = xlsread('Dynamic-Inputs-4','d2:d25');% Forecasted ambient temperature in degree C
[num] = xlsread('Dynamic-Inputs-4','b2:b25');% Time of the day as an numbers between 0 and 1
